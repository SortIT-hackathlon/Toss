...
class Robot:
    ...
    def set_cartesianRED(self, pose):
    ...
    def set_cartesianGREEN(self, pose):
        ...
        msg  = "38 " + self.format_pose(pose)  

        return self.send(msg)

   

    def set_cartesianBLUE(self, pose):
        ...
        msg  = "39 " + self.format_pose(pose)  

        return self.send(msg)

   

#    def set_cartesianBLACK(self, pose):
...
#        return self.send(msg)
    ...
    def set_cartesianTime(self, pose):
